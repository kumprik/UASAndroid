...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] nama,wahana,telpon,gambar,id;
    int jumdata;
    ...
    private void getlokasi(){
        String url="https://giswatersport.000webhostapp.com/watersport.php";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < jumdata; i++) {
                            try {
                                ...
                                wahana[i] = data.getString("wahana");
                                ...
                                for (int i = 0; i < jumdata; i++) {
                                    if (marker.getTitle().equals(nama[i])) {
                                        if (markerD[i]) {
                                            ...
                                            DetailActivity.wahana = wahana[i];
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this, "Klik lagi untuk melihat detail", Toast.LENGTH_LONG);
